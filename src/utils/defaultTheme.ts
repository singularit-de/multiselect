export const defaultTheme = {
  ...
  dropdown: 'max-h-60 -left-px -right-px border border-gray-300 -mt-px overflow-y-auto z-50 bg-white flex flex-col rounded-b',
...
export const baseStyle = {
  ...
  clear: 'pr-3.5 relative z-10 opacity-40 transition duration-300 flex-shrink-0 flex-grow-0 flex hover:opacity-80',
  clearIcon: 'text-lg font-bold text-center pl-3',
  dropdown: 'border -mt-px overflow-y-auto z-50 flex flex-col rounded-b',
  dropdownHidden: 'hidden',
