...
| **optionLabel**           | `function`                                                          |                                | Function that determines which attribute of the option object should be displayed as label. Passes an option as parameter. By default, it returns the label attribute of the passed option.                                                                                                                    |
